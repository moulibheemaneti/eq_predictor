...
class ReportTab extends StatefulWidget {
  ...
  //ReportTab(Key key, this.eqDataList) : super(key: key);
  ReportTab(this.eqDataList);
  @override
  State<StatefulWidget> createState() => new _ReportTabState();
}
...
class _ReportTabState extends State<ReportTab> {
  ...
  Widget build(BuildContext context) {
    ...
    var eqlatitude = double.parse(widget.eqDataList.first.latitude);
    var eqlongitude = double.parse(widget.eqDataList.first.longitude);
    return Padding(
      ...
      child: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            height: 170,
            width: 170,
            child: progressView("Major EQ",
                double.parse(widget.eqDataList.first.detection_probabilty) * 100),
          ),
          ...
          DataTable(
            ...
            rows: [
              DataRow(cells: [
                ...
                DataCell(Text(
                  "${widget.eqDataList.first.magnitude}",
                  style: mbTextStyle(),
                )),
              ...
              DataRow(cells: [
                ...
                DataCell(Text(
                  "${widget.eqDataList.first.detection_probabilty}",
                  style: mbTextStyle(),
                )),
              ...
              DataRow(cells: [
                ...
                DataCell(Text(
                  "(${eqlatitude.toStringAsFixed(2)} , ${eqlongitude.toStringAsFixed(2)})",
                  style: mbTextStyle(),
                )),
                //DataCell(Text("60",style: mbTextStyle(),)),
              ]),
              DataRow(cells: [
                ...
                DataCell(Text(
                  "${widget.eqDataList.first.station}",
                  style: mbTextStyle(),
                )),
                //DataCell(Text("60",style: mbTextStyle(),)),
              ]),
              DataRow(cells: [
                ...
                DataCell(Text(
                  "${widget.eqDataList.first.date_time}",
                  style: mbTextStyle(),
                )),
                //DataCell(Text("60",style: mbTextStyle(),)),
              ]),
